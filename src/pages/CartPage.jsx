      ...
      <Row>
                ...
                <ListGroup.Item key={item._id}>
                  <Row>
                    ...
                    <Col md={5} className="mt-5">
                      <Link
                        to={`/${item.type}-detail/${item._id}/${item.name}`}
                        className="text-black custom-cartpage-itemname"
                      >
                        {item.name}
                      </Link>
                      <Button
                    ...
                    <Col md={3}>
                      <Button
                        type="button"
                        variant="light"
                        className="mt-3 pt-1 custom-cartpage-deletebutton"
        ...
        <Col md={4} className="mt-5">
          <Card className="custom-cartpage-subtotalcard">
            <ListGroup variant="flush">
              <ListGroup.Item
                style={{ color: "black", backgroundColor: "light-grey" }}
              >
                <h3>
              ...
              <ListGroup.Item>
                <Button
                  type="button"
                  className="btn-block custom-cartpage-checkout"
