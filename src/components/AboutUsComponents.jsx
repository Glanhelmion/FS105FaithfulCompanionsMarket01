    ...
    <main>
      <div className="text-center mt-5 mb-5">
        ...
        <div className="word-wrap w-50 fw-light m-auto ">
          <div
            className="p-3 custom-aboutuscomponents-body"
            data-aos="fade-right"
            data-aos-delay="200"
          ...
          >
            <ul className="custom-aboutuscomponents-ulli">
              ...
              <li>
                Dedicated to enhancing the bond between pets and their owners
              </li>
          ...
          >
            <ul className="custom-aboutuscomponents-ulli">
              <h3>Our Mission</h3>
              <li>
                Provide a comprehensive, enjoyable online shopping experience.
              </li>
              ...
              <li>
                Commitment to honesty, integrity, and ethical practices in all
                our operations
              </li>
            </ul>
          </div>
          ...
          >
            <ul className="custom-aboutuscomponents-ulli">
              ...
              <li>
                User-friendly e-commerce platform with a focus on customer
                experience
              </li>
            </ul>
          </div>
          ...
          >
            <ul className="custom-aboutuscomponents-ulli">
              ...
              <li>
                Commitment to customer satisfaction and building lasting
                relationships
              </li>
            </ul>
          </div>
          ...
          >
            <ul className="custom-aboutuscomponents-ulli">
              <h3>Our Promise</h3>
              <li>
                To deliver the best online shopping experience for pet-related
                needs
              </li>
              <li>
                Ensuring a safe, secure, and enjoyable process for all our
                customers
              </li>
            </ul>
          </div>
          ...
          >
            <ul className="custom-aboutuscomponents-ulli">
              ...
              <li>
                Easy-to-use contact options: live chat, email, and a feedback
                form
              </li>
              <li>
                Our team is always here to assist with any queries or concerns
              </li>
            </ul>
          </div>
          <div
