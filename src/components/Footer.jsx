      ...
      <div className="footer-content">
        ...
        <div className="footer-section">
          <h5 className="custom-footer-subheader text-uppercase">Information</h5>
            ...
            <a href="/terms-and-conditions" className="text-decoration-none text-black"><p className="custom-footer-content">Terms & Conditions</p></a>
        ...
        <div className="footer-section">
          <h5 className="custom-footer-subheader text-uppercase">Get In Touch With Us</h5>
          <a href="https://www.google.com/maps/dir//2+Orchard+Link,+Singapore+237978/@1.3009719,103.7533444,12z/data=!4m8!4m7!1m0!1m5!1m1!1s0x31da19899d6c6d09:0x3a86b4835cf91386!2m2!1d103.8357464!2d1.3009732?hl=en-SG&entry=ttu" className="text-decoration-none text-black"><p className="custom-footer-content-address">2 Orchard Link, Singapore 237978</p></a>
          <p className="custom-footer-content">Phone: (65) 6789 3412</p>
          <p className="custom-footer-content">Monday to Friday: 10AM - 7PM
          <br></br>
