...
const MainBanner = () => {
  return (
    <Container
      fluid
      className="image-banner-container custom-mainbanner-maincontainer"
    >
      <Row className="gx-0 horizontal-photos d-flex flex-wrap custom-mainbanner">
        <Col xs={2} className="">
          <a href="/cats" rel="noopener noreferrer">
            <img
              src={cat1}
              alt="Cat 1"
              className="banner-image img-fluid custom-mainbanner-catpic"
            />
          </a>
        </Col>

        <Col xs={2} className="">
          <a href="/dogs" rel="noopener noreferrer">
            {" "}
        ...
        <Col xs={2} className="">
          <a href="/birds" rel="noopener noreferrer">
            <img
              src={parrot1}
              alt="Parrot 1"
        ...
        <Col xs={2} className="">
          <a href="/fishes" rel="noopener noreferrer">
            <img
              src={greenarrowana1}
              alt="Fish 1"
              className="banner-image img-fluid"
        ...
        <Col xs={2} className="">
          <a href="/petaccessories" rel="noopener noreferrer">
            {" "}
            <img
              src={pet_accessories}
              alt="Accessories"
        ...
        <Col xs={2} className="">
          <a href="/petfoods" rel="noopener noreferrer">
            {" "}
            <img
              src={petfood2}
              alt="Pet Food"
              className="banner-image img-fluid custom-mainbanner-petfoodpic"
            />
          </a>
        </Col>
      </Row>
